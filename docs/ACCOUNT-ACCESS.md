...
September 11, 2026. Deployed to the hosted Railway beta; real-inbox email delivery remains to be checked. The answering model remains Meforash 0.1 (retained original-text-only B). No training, prompt change, or streaming change accompanies this work.
