"""Bounded Modal serving pilot for the pinned gpt-oss-20b base.
...
VOLUME_NAME = "meforash-modal-serving-v1-weights"
...
APP_NAME = (
    "meforash-modal-serving-v1-snapshot"
    if SNAPSHOT_ENABLED
    else "meforash-modal-serving-v1-baseline"
)
...
def _read_and_verify_manifest() -> dict[str, Any]:
...
def prepare_weights() -> dict[str, Any]:
    ...
    if MANIFEST_PATH.exists():
        return _read_and_verify_manifest()
